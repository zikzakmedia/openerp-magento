...
class product_category(osv.osv):
    ...
    _columns = {
        ...
        'magento_description': fields.text('Description', translate=True),
        'magento_meta_title': fields.text('Meta Title', translate=True),
        'magento_meta_keywords': fields.text('Meta Keyword', translate=True),
        'magento_meta_description': fields.text('Meta Description', help="Almost all search engines recommend it to be shorter than 155 characters of plain text", translate=True),
